...
def TrainTasks():
    ...
    with open("/home/r1/r1_ws/src/voice/voice/ai_assistant/Data/tasks.json",'r') as f:
        intents = json.load(f)
    ...
    FILE = "/home/r1/r1_ws/src/voice/voice/ai_assistant/Data/tasks.pth"
...
def TasksExecutor(query):
    ...
    with open('/home/r1/r1_ws/src/voice/voice/ai_assistant/Data/tasks.json','r') as json_data:
