...
#ifndef LEX_COMMON_MSGS__SRV__DETAIL__AUDIO_TEXT_CONVERSATION__FUNCTIONS_H_
#define LEX_COMMON_MSGS__SRV__DETAIL__AUDIO_TEXT_CONVERSATION__FUNCTIONS_H_
...
#include "lex_common_msgs/msg/rosidl_generator_c__visibility_control.h"

#include "lex_common_msgs/srv/detail/audio_text_conversation__struct.h"

/// Initialize srv/AudioTextConversation message.
/**
...
/// Create srv/AudioTextConversation message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lex_common_msgs__srv__AudioTextConversation_Request__init().
...
/// Destroy srv/AudioTextConversation message.
/**
 * It calls
 * lex_common_msgs__srv__AudioTextConversation_Request__fini()
...
/// Check for srv/AudioTextConversation message equality.
/**
...
/// Copy a srv/AudioTextConversation message.
/**
...
/// Initialize array of srv/AudioTextConversation messages.
/**
...
/// Finalize array of srv/AudioTextConversation messages.
/**
 * It calls
 * lex_common_msgs__srv__AudioTextConversation_Request__fini()
...
/// Create array of srv/AudioTextConversation messages.
/**
 * It allocates the memory for the array and calls
 * lex_common_msgs__srv__AudioTextConversation_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AudioTextConversation messages.
/**
 * It calls
 * lex_common_msgs__srv__AudioTextConversation_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AudioTextConversation message array equality.
/**
...
/// Copy an array of srv/AudioTextConversation messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lex_common_msgs__srv__AudioTextConversation_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lex_common_msgs
...
/**
 * It calls
 * lex_common_msgs__srv__AudioTextConversation_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_lex_common_msgs
...
/**
 * It allocates the memory for the array and calls
 * lex_common_msgs__srv__AudioTextConversation_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lex_common_msgs
...
/**
 * It calls
 * lex_common_msgs__srv__AudioTextConversation_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LEX_COMMON_MSGS__SRV__DETAIL__AUDIO_TEXT_CONVERSATION__FUNCTIONS_H_
