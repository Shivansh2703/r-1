...
#include "lex_common_msgs/msg/detail/key_value__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const lex_common_msgs::msg::KeyValue *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lex_common_msgs::msg::KeyValue *>(
    untyped_ros_message);
...
{
  return &lex_common_msgs::msg::typesupport_fastrtps_cpp::_KeyValue__handle;
}
