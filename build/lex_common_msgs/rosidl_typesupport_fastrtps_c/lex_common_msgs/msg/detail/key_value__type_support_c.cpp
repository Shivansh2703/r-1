...
#include "lex_common_msgs/msg/detail/key_value__rosidl_typesupport_fastrtps_c.h"
...
using _KeyValue__ros_msg_type = lex_common_msgs__msg__KeyValue;
...
static uint32_t _KeyValue__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lex_common_msgs__msg__KeyValue(
...
static size_t _KeyValue__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lex_common_msgs__msg__KeyValue(
