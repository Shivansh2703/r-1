...
{
  new (message_memory) lex_common_msgs::msg::KeyValue(_init);
}

void KeyValue_fini_function(void * message_memory)
{
  auto typed_message = static_cast<lex_common_msgs::msg::KeyValue *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember KeyValue_message_member_array[2] = {
  {
    ...
    offsetof(lex_common_msgs::msg::KeyValue, key),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lex_common_msgs::msg::KeyValue, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers KeyValue_message_members = {
  "lex_common_msgs::msg",  // message namespace
  "KeyValue",  // message name
  2,  // number of fields
  sizeof(lex_common_msgs::msg::KeyValue),
...
get_message_type_support_handle<lex_common_msgs::msg::KeyValue>()
{
  return &::lex_common_msgs::msg::rosidl_typesupport_introspection_cpp::KeyValue_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lex_common_msgs, msg, KeyValue)() {
  return &::lex_common_msgs::msg::rosidl_typesupport_introspection_cpp::KeyValue_message_type_support_handle;
}
