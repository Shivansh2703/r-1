...
bool lex_common_msgs__msg__key_value__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lex_common_msgs.msg._key_value.KeyValue", full_classname_dest, 39) == 0);
  }
  lex_common_msgs__msg__KeyValue * ros_message = _ros_message;
  {  // key
...
PyObject * lex_common_msgs__msg__key_value__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lex_common_msgs.msg._key_value");
